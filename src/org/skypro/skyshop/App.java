...
public class App {
    public static void main(String[] args) {
        ...
        Article article2 = new Article("Маленькие мастера уюта. Хомяки", "Хомяки — это крошечные пушистики, чья жизнь выглядит как нескончаемый сериал о еде, сне и неожиданном беге в колесе. Эти грызуны, несмотря на свои скромные размеры, обладают харизмой, достойной блокбастера.");
        Article article3 = new Article("Карманные интроверты. Хомяки", "Эти ребята обожают уединение. Посади двух взрослых хомяков в одну клетку — и это уже не милый мультик, а триллер со смертельным исходом. Особенно, если это сирийские хомяки: у них личное пространство размером с Сахару. В общем, если вам нужен пушистый социопат, который смотрит на мир с подозрением, но всё равно милый — хомяк подойдёт идеально.");
        Article article4 = new Article("Генералы диванной обороны. Хомяки", "Хомяк — это животное, которое выглядит как комочек счастья, но ведёт себя как ветеран постапокалипсиса. Он всё прячет, всё боится, на всякий случай роет окопы в углу клетки и не доверяет даже своей поилке.");
